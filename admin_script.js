 ...
 * التوثيق: تم إعداد هذا الملف ليرسل البيانات حياً إلى جدول Google Sheets مثبت الأبعاد
 */
...
/**
 * دالة حفظ البيانات: ترسل البيانات حياً إلى الإكسل وتحتفظ بنسخة احتياطية محلية
